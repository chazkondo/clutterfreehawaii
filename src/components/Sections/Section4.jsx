...
//                                 style={{ width: '75%' }} src={
//                                     backgroundDark ?
//                                         require("../../assets/img/home.png") : require("../../assets/img/apartment.png")} alt="" />
//                         </div>
//                         <div style={{ textAlign: 'left', flex: 1, display: 'flex', flexDirection: 'column', padding: '4%', paddingLeft: 0, paddingTop: 0 }}>
//                             <motion.h3 animate={headerDetected() ? 'unfadedFaster' : 'faded'}
//                                 variants={variants} ref={headerRef} style={{ color: backgroundDark ? 'white' : 'black', paddingBottom: 0, marginBottom: 0, fontSize: '1.7rem', letterSpacing: '4px' }}>System Maintenance</motion.h3>
//                             <motion.h2 animate={headerDetected() ? 'unfadedFaster' : 'faded'}
//                                 variants={variants} style={{ color: backgroundDark ? 'white' : 'black', letterSpacing: '-0.28rem', paddingTop: '0%', marginTop: 0, paddingBottom: '10%' }}>Result-Focused.</motion.h2>
