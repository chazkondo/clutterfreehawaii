...
export default function MyBackgroundImage({ backgroundOpacity, setLoaded }) {
    const data = useStaticQuery(
        graphql`
            query {
                static1: file(
                    relativePath: { eq: "creative-commons-zen-large.jpg" }
                ) {
                    childImageSharp {
                ...
                static2: file(
                    relativePath: { eq: "creative-commons-zen.jpg" }
                ) {
                    childImageSharp {
                ...
                static3: file(
                    relativePath: { eq: "creative-commons-zen-small.jpg" }
                ) {
                    childImageSharp {
                ...
                static4: file(
                    relativePath: { eq: "creative-commons-zen-xs.jpg" }
                ) {
                    childImageSharp {
